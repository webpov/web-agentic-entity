...
export class TwitterSearchClient extends ClientBase {
    ...
    constructor(runtime: IAgentRuntime) {
        console.log("Twitter search client constructor TwitterSearchClient TwitterSearchClient TwitterSearchClient");
    ...
    async onReady() {
        console.log("Twitter search client ready, starting engageWithSearchTermsLoop ");
        console.log("****** engageWithSearchTermsLoop engageWithSearchTermsLoop engageWithSearchTermsLoop ******");
